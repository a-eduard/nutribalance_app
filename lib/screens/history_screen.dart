...
import '../widgets/base_background.dart'; // 1. ИМПОРТ ФОНА
...
class HistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // 2. ОБЕРТКА ВСЕГО ЭКРАНА В ФОН
    return BaseBackground(
      child: Scaffold(
        backgroundColor: Colors.transparent, // 3. ПРОЗРАЧНЫЙ ФОН SCAFFOLD
        appBar: AppBar(
          title: const Text("ИСТОРИЯ", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
          backgroundColor: Colors.transparent, // 4. ПРОЗРАЧНЫЙ APPBAR
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        // 5. ПОЛУПРОЗРАЧНАЯ КАРТОЧКА для эффекта глубины
